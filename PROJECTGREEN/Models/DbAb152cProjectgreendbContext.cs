...
public partial class DbAb152cProjectgreendbContext : DbContext
{
    public DbAb152cProjectgreendbContext()
    {
    }

    public DbAb152cProjectgreendbContext(DbContextOptions<DbAb152cProjectgreendbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Data Source=SQL1001.site4now.net;Initial Catalog=db_ab152c_projectgreendb;User Id=db_ab152c_projectgreendb_admin;Password=jules0019");
